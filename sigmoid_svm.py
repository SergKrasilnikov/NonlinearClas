...
with Sigmoid kernel (sigmoid) transformation

This classification is not working well yet.
I need to figure out what parameters could be set for the gamma and coef0

Created on Wed Jun 14 10:54:25 2023
...
model = SVC(kernel='sigmoid', gamma=0.001, coef0=-100)
model.fit(df, weight)
...
# # Создание экземпляра модели SVM с Sigmoid Kernel
...
#     'coef0': [-100.0, -10.0, 1.0, 10.0, 100.0]
# }
...
# grid_search.fit(df, weight)

# # Вывод наилучших параметров
# print("Best Parameters: ", grid_search.best_params_)

# # Оценка производительности модели на тестовых данных
# accuracy = grid_search.score(df, weight)
